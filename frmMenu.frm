...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About TenShillings Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "TenShillings One Page Help"
      End
...
Private Sub mnuAppFolder_Click()
   ...
   On Error GoTo mnuAppFolder_Click_Error
    ...
    Else
        ...
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "TenShillings Widget Confirmation Message", vbOKOnly + vbExclamation
    End If
...
' Author    : beededea
' Date      : 14/05/2023
' Purpose   : menu item to hide the main widget form
'---------------------------------------------------------------------------------------
'
...
' Author    : beededea
' Date      : 05/05/2023
' Purpose   : menu item to lock the widgetForm in place
'---------------------------------------------------------------------------------------
'
...
' Author    : beededea
' Date      : 07/05/2023
' Purpose   : menu item to lock the widgetForm in place on the desktop
'---------------------------------------------------------------------------------------
'
